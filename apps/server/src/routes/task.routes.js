...
import { addComment, cancelTask, completeTask, createTask, deleteTask, listTasks, reopenTask, startTask, updateTask } from '../controllers/task.controller.js';
...
taskRoutes.patch('/:taskId/reopen', reopenTask);
