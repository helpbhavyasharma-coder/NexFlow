...
export function AuthExperience({ mode, title, subtitle, children }) {
  ...
  return (
    <div className="relative min-h-[100svh] overflow-x-hidden bg-slate-950 text-white">
      ...
      <main className="relative mx-auto grid min-h-[100svh] w-full max-w-[1500px] items-start gap-5 px-4 py-5 sm:px-6 lg:grid-cols-[1fr_0.95fr] lg:items-center lg:gap-8 lg:px-8">
        <motion.section
          initial={{ opacity: 0, x: -30 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.55 }}
          className="order-2 flex flex-col justify-center rounded-none py-3 lg:order-1 lg:py-4"
        >
          ...
          <div className="max-w-2xl">
            ...
            <motion.h1
              ...
              className="text-3xl font-black leading-tight text-white sm:text-5xl lg:text-[3.45rem] lg:leading-[1.03] 2xl:text-[4rem]"
            >
        ...
        >
          <div className="w-full max-w-md rounded-lg border border-white/15 bg-white/[0.08] p-5 shadow-2xl shadow-cyan-950/40 backdrop-blur-2xl sm:p-6 xl:max-w-lg">
            <div className="mb-5 flex items-center gap-4 lg:hidden">
              <img src="/brand/nexflow-full-logo-cropped.webp" alt="NexFlow" className="h-20 w-auto object-contain sm:h-24" />
            </div>
            <div className="mb-6">
